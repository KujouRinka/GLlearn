...
int main() {
  ...
  GLuint vertexShader, fragmentShader, fragmentShaderYellow;
  ...
  if (!success) {
    glGetShaderInfoLog(fragmentShaderYellow, 512, nullptr, err_msg);
    std::cout << "fragment shader yellow compiled failed:\n" << err_msg << std::endl;
  }
  ...
  if (!success) {
    glGetProgramInfoLog(shaderProgramYellow, 512, nullptr, err_msg);
    std::cout << "shader yellow link failed:\n" << err_msg << std::endl;
  }
