...
void mouse_callback(GLFWwindow *window, double xpos, double ypos) {
  ...
  // glm::vec3 right_axis = glm::normalize(glm::cross(cameraFront, cameraUp));
  // glm::vec3 up_axis = glm::normalize(glm::cross(right_axis, cameraFront));
  // base = glm::rotate(base, glm::radians(y_offset), right_axis); // left vector
  // base = glm::rotate(base, -glm::radians(x_offset), up_axis); // up

  // glm::vec4 v{cameraFront.x, cameraFront.y, cameraFront.z, 0};
  // v = base * v;
  // cameraFront.x = v.x;
  // cameraFront.y = v.y;
  // cameraFront.z = v.z;
