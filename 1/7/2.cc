...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    float factor = glm::abs(glm::sin(glfwGetTime()));
    glm::mat4 trans3 = glm::scale(trans2, glm::vec3{factor, factor, 0.0f});
    glUniformMatrix4fv(glGetUniformLocation(shader.getHandler(), "transform"), 1, GL_FALSE, glm::value_ptr(trans3));
    glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void *) 0);
